export class AudioEngine {
  ...
  public playGunshot(weaponId: string = 'assault_rifle'): void {
    if (!this.ctx) return;
    ...
    filter.type = 'lowpass';
    filter.frequency.setValueAtTime(weaponId === 'sniper' ? 1200 : 3000, now);
    filter.frequency.exponentialRampToValueAtTime(100, now + 0.15);

    // Gain envelope for punchy snap
  ...
  public playHitmarker(isHeadshot: boolean = false): void {
    ...
    osc.frequency.exponentialRampToValueAtTime(isHeadshot ? 2400 : 1200, now + 0.05);
